...
const Navbar = () => {
  ...
  <div className="navbar-end">
    <a href='https://drive.google.com/file/d/1E9T8MyFUqOMYcXvA7GQAZeYOVziWuUsS/view?usp=sharing' className="btn bg-white text-green-700 border-green-800 hover:bg-green-700 hover:text-white">Resume</a>
  </div>
</div>
        </div>
    );
